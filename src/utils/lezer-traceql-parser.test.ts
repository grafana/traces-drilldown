...
describe('Lezer TraceQL Parser', () => {
  describe('parseTraceQLQuery', () => {
    ...
    it('should combine multiple values for same field into array (Query Builder pattern)', () => {
      // This is the exact syntax generated by Tempo Query Builder for multiple values
      ...
      // This recreates the original Query Builder filter structure:
      // - Single TraceqlFilter with array value 
      // - Matches what filterToQuerySection() in SearchTraceQLEditor/utils.ts expects
